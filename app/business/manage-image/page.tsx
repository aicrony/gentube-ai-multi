...
function UploadImageContent() {
  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 sm:px-4 py-8 mt-16 pt-4">
      <div className="mb-8 text-center">
        ...
        <p className="text-lg">View, delete, and download images and videos</p>
        <p className="mt-2">
          {credits !== null
      ...
      {/*  >*/}
      {/*    <h2 className="text-xl font-bold">Step 1: Upload an Image</h2>*/}
      {/*    <span>*/}
      {/*      {openSteps[1] ? (*/}
      ...
      >
        <button
          ...
          className="w-full text-left flex justify-between items-center"
        >
          <h2 className="text-xl font-bold">View & Manage Your Assets</h2>
          <span>
            {openSteps[1] ? (
              <FaChevronDown size={18} />
            ) : (
